...
export default function NoContextTestPage() {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-4">No Context Test Page</h1>
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-600">
          This page bypasses the auth and data store contexts.
        </p>
      </div>
    </div>
  )
