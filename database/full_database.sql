-- =============================================================================
-- BakeSync IAS102 — Complete database script (single file)
-- MySQL 8.0+ compatible
--
-- Usage: run this file on a fresh MySQL instance (or empty `defaultdb`).
--        Re-running seed INSERTs will fail if users already exist — use a
--        clean database or edit/remove the INSERT sections.
--
-- Twin file: database/schema.sql (kept in sync; edit one and mirror changes)
-- Incremental upgrades: database/migrations/*.sql
-- Human-readable copy: docs/DATABASE.md
-- =============================================================================
