...
async function sendPasswordResetOTPEmail(toEmail, username, otpCode) {
    try {
        const { data, error } = await resend.emails.send({
            from: 'BakeSync <onboarding@resend.dev>',
            to: toEmail,
            subject: 'BakeSync password reset code',
            html: `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>BakeSync Password Reset</title>
</head>
<body style="
  margin: 0;
  padding: 0;
          ...
          <tr>
            <td style="padding: 36px 40px 24px 40px; text-align: center;">
              ...
              <p style="margin: 0; font-size: 14px; color: #78716c;">
                Use the code below to finish resetting your BakeSync password.
              </p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="padding: 32px 40px 0 40px;">
              ...
              <p style="
                ...
                color: #78716c;
              ">
                Someone requested a password reset for your account. If this was you, enter this code
                on the reset page. The code expires in 10 minutes.
              </p>
              <div style="
                background: #f3f0eb;
                border: 1px solid #e7e5e0;
              ...
              ">
                ...
                <div style="
                  ...
                  padding: 6px 14px;
                ">
                  <span style="font-size: 12px; color: #d97706; font-weight: 500;">Expires in 10 minutes</span>
                </div>
              </div>
              <div style="
                background: #faf8f5;
                ...
                margin-bottom: 28px;
              ">
                <p style="margin: 0; font-size: 13px; color: #5c4d3c; line-height: 1.5;">
                  <strong>Security:</strong> If you did not request a reset, ignore this email. Your password will not change.
                </p>
              </div>
            </td>
          </tr>
          <tr>
            <td style="padding: 0 40px 36px 40px;">
              ...
              <p style="
                ...
                line-height: 1.6;
              ">
                BakeSync · Bakery Management System<br/>Please do not reply to this email.
              </p>
            </td>
          </tr>
          <tr>
...
`,
        ...
        console.log(`[Mailer] Password reset OTP sent to ${toEmail} for ${username}`);
    } catch (err) {
        console.error('[Mailer] Failed to send email:', err && err.message ? err.message : err);
        throw err;
    }
